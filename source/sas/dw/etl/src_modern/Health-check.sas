...
FROM nbs_cdc.PERSON,nbs_cdc.PARTICIPATION
...
FROM nbs_cdc.PERSON, nbs_cdc.CT_CONTACT
...
FROM HEALTH_CHECK_PATIENT HC LEFT OUTER JOIN nbs_cdc.PUBLIC_HEALTH_CASE PHC ON
