...
FROM nbs_cdc.PERSON WHERE PERSON.CD='PRV'
...
RUN;
PROC SQL;
CREATE TABLE S_PROVIDER_NAME AS SELECT FIRST_NM,LAST_NM,MIDDLE_NM,NM_SUFFIX,NM_PREFIX,NM_DEGREE, NM_USE_CD,PERSON_NAME.PERSON_UID AS  PROVIDER_UID ' PROVIDER_UID' FROM  PROVIDER_UID_COLL INNER JOIN nbs_cdc.PERSON_NAME
...
FROM PROVIDER_UID_COLL LEFT OUTER JOIN nbs_cdc.ENTITY_LOCATOR_PARTICIPATION
...
FROM PROVIDER_UID_COLL INNER JOIN nbs_cdc.ENTITY_LOCATOR_PARTICIPATION
ON PROVIDER_UID_COLL.PROVIDER_UID= ENTITY_LOCATOR_PARTICIPATION.ENTITY_UID
...
FROM PROVIDER_UID_COLL LEFT OUTER JOIN nbs_cdc.ENTITY_ID
