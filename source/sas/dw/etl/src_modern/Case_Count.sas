...
from nbs_cdc.public_health_case;
...
From
	...
	left join nbs_cdc.participation	as par1
	...
	left join nbs_cdc.participation	as par3
	...
	left join nbs_cdc.participation	as par4
	...
	/* Reporting Org */
	left join nbs_cdc.participation	 as par5
	...
	/* ADT Hospital Org */
	left join nbs_cdc.participation	as par6
...
create table sumcasecnt as
	...
	from 	
		Case_Count1	phc,
		nbs_cdc.act_relationship as ar1, 	/*-- OBS sum107 to OBS Summary_Report_Form */
		nbs_cdc.observation as ob1, 		/*--SUM107 */
		nbs_cdc.observation as ob2, 		/* --Summary_Report_Form*/
		nbs_cdc.obs_value_numeric as ovn, 	/*--group_case_cnt*/
		nbs_cdc.act_relationship as ar2 	/*OBS Summary_Report_Form to phc */ 
	where 	
		phc.case_type_cd ='S'
