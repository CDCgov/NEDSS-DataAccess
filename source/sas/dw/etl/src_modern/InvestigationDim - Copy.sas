...
DELETE FROM nbs_rdb.L_CONFIRMATION_METHOD WHERE INVESTIGATION_KEY IN (SELECT INVESTIGATION_KEY FROM INVESTIGATION_E_KEYHOLDER);
/*
DELETE FROM nbs_rdb.L_CONFIRMATION_METHOD lcm
join INVESTIGATION_E_KEYHOLDER i on i.INVESTIGATION_KEY = lcm.INVESTIGATION_KEY;*/
QUIT;
