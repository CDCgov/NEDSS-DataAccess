...
from	BMD265_1 as a,
		nbs_cdc.obs_value_numeric as b
...
/*BMD267 nbs_cdc.Obs_Value_Date.Duration_Amt*/
/*
...
from	&fact_table1 a 
	left join nbs_cdc.participation as par 
...
from	rdbdata.Bmird_Case4 as a
	inner join nbs_cdc.participation as par
		on a.public_health_case_uid = par.act_uid
	inner join nbs_cdc.person	as per
		on par.type_cd = 'MaternalPSN'
		and par.subject_entity_uid = per.person_uid
	inner join nbs_cdc.person_name	as pn1
