...
DELETE FROM S_PATIENT; -- Getting dropped in sp_D_Patient
GO
...
DELETE FROM S_INVESTIGATION; -- Before running InvestigationDim.sas
GO
DELETE FROM S_CONFIRMATION_METHOD_GROUP; -- Before running InvestigationDim.sas
GO
...
IF OBJECT_ID ('dbo.REF_FORMCODE_TRANSLATION') IS NOT NULL DROP TABLE REF_FORMCODE_TRANSLATION;
GO
...
INSERT INTO DBO.REF_FORMCODE_TRANSLATION (PAGE_CODE_SET_NM, INVESTIGATION_FORM_CD,CODE_VALUE_GENERAL.CODE_SET_NM,CODE_VALUE_GENERAL.CODE,
CODE_VALUE_GENERAL.CODE_SHORT_DESC_TXT, NBS_UI_METADATA.CODE_SET_GROUP_ID, NBS_UI_METADATA.QUESTION_IDENTIFIER,NBS_UI_METADATA.NBS_QUESTION_UID)
...
IF OBJECT_ID ('DBO.INV_SUMM_DATAMART', 'U') IS  NULL 
...
IF OBJECT_ID ('dbo.RDB_TABLE_METADATA', 'U') IS NOT NULL DROP TABLE RDB_TABLE_METADATA;
GO
IF OBJECT_ID ('dbo.RDB_METADATAINIT_TEMP', 'U') IS NOT NULL DROP TABLE RDB_METADATAINIT_TEMP;
GO
IF OBJECT_ID ('dbo.CODESETGROUPID_TEMP', 'U') IS NOT NULL DROP TABLE CODESETGROUPID_TEMP;
GO
IF OBJECT_ID ('dbo.CODESETNAME_TEMP', 'U') IS NOT NULL DROP TABLE CODESETNAME_TEMP;
GO
...
/* 
-- The below scripts are not needed as the tables are getting dropped in the corrsponding sp_S_Inv_{} SQL Procedures
IF OBJECT_ID ('DBO.S_INV_ADMINISTRATIVE', 'U') IS NOT NULL TRUNCATE  TABLE S_INV_ADMINISTRATIVE;
GO
IF OBJECT_ID ('DBO.S_INV_CLINICAL', 'U') IS NOT NULL TRUNCATE  TABLE S_INV_CLINICAL;
GO
IF OBJECT_ID ('DBO.S_INV_COMPLICATION', 'U') IS NOT NULL TRUNCATE  TABLE S_INV_COMPLICATION;
GO
IF OBJECT_ID ('DBO.S_INV_CONTACT', 'U') IS NOT NULL TRUNCATE  TABLE S_INV_CONTACT;
GO
IF OBJECT_ID ('DBO.S_INV_DEATH', 'U') IS NOT NULL TRUNCATE  TABLE S_INV_DEATH;
GO
IF OBJECT_ID ('DBO.S_INV_EPIDEMIOLOGY', 'U') IS NOT NULL TRUNCATE  TABLE S_INV_EPIDEMIOLOGY;
GO
IF OBJECT_ID ('DBO.S_INV_HIV', 'U') IS NOT NULL TRUNCATE  TABLE S_INV_HIV;
GO
IF OBJECT_ID ('DBO.S_INV_PATIENT_OBS', 'U') IS NOT NULL TRUNCATE  TABLE S_INV_PATIENT_OBS;
GO
IF OBJECT_ID ('DBO.S_INV_ISOLATE_TRACKING', 'U') IS NOT NULL TRUNCATE  TABLE S_INV_ISOLATE_TRACKING;
GO
IF OBJECT_ID ('DBO.S_INV_LAB_FINDING', 'U') IS NOT NULL TRUNCATE  TABLE S_INV_LAB_FINDING;
GO
IF OBJECT_ID ('DBO.S_INV_MEDICAL_HISTORY', 'U') IS NOT NULL TRUNCATE  TABLE S_INV_MEDICAL_HISTORY;
GO
IF OBJECT_ID ('DBO.S_INV_MOTHER', 'U') IS NOT NULL TRUNCATE  TABLE S_INV_MOTHER;
GO
IF OBJECT_ID ('DBO.S_INV_OTHER', 'U') IS NOT NULL TRUNCATE  TABLE S_INV_OTHER;
GO
IF OBJECT_ID ('DBO.S_INV_PREGNANCY_BIRTH', 'U') IS NOT NULL TRUNCATE  TABLE S_INV_PREGNANCY_BIRTH;
GO
IF OBJECT_ID ('DBO.S_INV_RESIDENCY', 'U') IS NOT NULL TRUNCATE  TABLE S_INV_RESIDENCY;
GO
IF OBJECT_ID ('DBO.S_INV_RISK_FACTOR', 'U') IS NOT NULL TRUNCATE  TABLE S_INV_RISK_FACTOR;
GO
IF OBJECT_ID ('DBO.S_INV_SOCIAL_HISTORY', 'U') IS NOT NULL TRUNCATE  TABLE S_INV_SOCIAL_HISTORY;
GO
IF OBJECT_ID ('DBO.S_INV_SYMPTOM', 'U') IS NOT NULL TRUNCATE  TABLE S_INV_SYMPTOM;
GO
IF OBJECT_ID ('DBO.S_INV_TREATMENT', 'U') IS NOT NULL TRUNCATE  TABLE S_INV_TREATMENT;
GO
IF OBJECT_ID ('DBO.S_INV_TRAVEL', 'U') IS NOT NULL TRUNCATE  TABLE S_INV_TRAVEL;
GO
IF OBJECT_ID ('DBO.S_INV_UNDER_CONDITION', 'U') IS NOT NULL TRUNCATE  TABLE S_INV_UNDER_CONDITION;
GO
IF OBJECT_ID ('DBO.S_INV_VACCINATION', 'U') IS NOT NULL TRUNCATE  TABLE S_INV_VACCINATION;
GO
*/

-- Call the ETL Part 1 Proc
-- Exec dbo.[sp_ETL_PART1_ALL]; -- for production

-- For Hepatitis POC
Exec dbo.sp_ETL_Part1_Start;
