...
@sqlcmd -S <db_server> -U nbs_rdb -P rdb -d rdb_modern -Q "Exec rdb_modern.dbo.sp_connection_test" > D:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\log_modern\sp_connection_test.log

@rem test connectivity to nbs_changedata
sqlcmd -S <db_server> -U nbs_ods -P ods -d nbs_changedata -Q "Exec nbs_changedata.dbo.sp_connection_test" > D:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\log_modern\sp_connection_test_changedata.log
...
sqlcmd -S <db_server> -U nbs_rdb -P rdb -d rdb_modern -Q "Exec rdb_modern.dbo.sp_ETL_PART1_Start" > D:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\log_modern\sp_ETL_PART1_Start.log
...
@rem sqlcmd -S <db_server> -U nbs_rdb -P rdb -d rdb_modern -Q "Exec rdb_modern.dbo.sp_SLD_ALL_Hep" > D:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\log_modern\sp_SLD_ALL_Hep.log
