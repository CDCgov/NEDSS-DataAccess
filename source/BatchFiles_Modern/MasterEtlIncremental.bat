...
:true
@rem ORACLE SETTINGS
sqlplus nbs_rdb/rdb@nbs_rdb @C:\wildfly-10.0.0.Final\nedssdomain\Nedss\BatchFiles_Modern\Incremental_Refresh_Oracle_Tables.sql > C:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\log_modern\Drop_Create_Tables.log
@rem type C:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\log_modern\Drop_Create_Tables.log
GOTO END
:false 
@rem SQL SERVER SETTINGS
osql -U nbs_rdb -P rdb -S CDCDEVDB2\rdb -d rdb -i C:\wildfly-10.0.0.Final\nedssdomain\Nedss\BatchFiles_Modern\Incremental_Refresh_SqlServer_Tables.sql> C:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\log_modern\Drop_Create_Tables.log
@rem type C:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\log_modern\Drop_Create_Tables.log 
GOTO END
:END	
@rem execute the SAS MasterEtl program 
%SAS_HOME%\sas.exe -sysin C:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\dw\etl\src_modern\MasterETL.sas -nosyntaxcheck -print C:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\log_modern\MasterETL.lst -log C:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\log_modern\MasterETL.log -config  %SAS_HOME%\SASV9.CFG -autoexec C:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\autoexec-modern.sas
@rem type C:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\log_modern\MasterETL.log 
:cannotproceed
