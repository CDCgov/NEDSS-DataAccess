...
BEGIN TRY
    ...
    select cmt.INVESTIGATION_KEY,	cmk.D_CONFIRMATION_METHOD_KEY,	cmt.CONFIRMATION_DT
      from #temp_cm_table cmt
      join dbo.nrt_confirmation_method_key cmk on cmt.confirmation_method_cd = cmk.confirmation_method_cd
