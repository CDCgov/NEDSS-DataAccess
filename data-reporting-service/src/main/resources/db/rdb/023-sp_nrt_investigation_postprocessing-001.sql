...
update cm
set cm.CONFIRMATION_METHOD_DESC = cmt.CONFIRMATION_METHOD_DESC_TXT from #temp_cm_table cmt
...
update cmg
set cmg.CONFIRMATION_DT = cmt.CONFIRMATION_DT from #temp_cm_table cmt
