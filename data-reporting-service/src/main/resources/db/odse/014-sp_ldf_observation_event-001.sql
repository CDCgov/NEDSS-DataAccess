CREATE OR ALTER PROCEDURE dbo.sp_ldf_observation_event @ldf_uid_list nvarchar(max), @bus_obj_uid_list nvarchar(max)
...
d.version_ctrl_nbr ldf_field_data_version_ctrl_num , cvg.code_desc_txt as LDF_COLUMN_TYPE
 from  nbs_odse.dbo.State_Defined_Field_MetaData m
   join nbs_odse.dbo.State_Defined_Field_Data d on m.ldf_uid = d.ldf_uid  and d.business_object_nm = 'LAB'
   ...
   join nbs_odse.dbo.Observation o on d.business_object_uid=o.observation_uid   
