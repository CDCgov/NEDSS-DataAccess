...
d.version_ctrl_nbr ldf_field_data_version_ctrl_num , cvg.code_desc_txt as LDF_COLUMN_TYPE
 from  nbs_odse.dbo.State_Defined_Field_MetaData m
   join nbs_odse.dbo.State_Defined_Field_Data d on m.ldf_uid = d.ldf_uid  and d.business_object_nm = 'VAC'
   ...
   join nbs_odse.dbo.Intervention i on d.business_object_uid=i.intervention_uid    
