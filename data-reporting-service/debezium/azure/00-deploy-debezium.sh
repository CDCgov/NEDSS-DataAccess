...
export RESOURCE_GROUP="rtr-debezium"
export EVENTHUB_NAME="rtr-debezium"
export CONTAINER_NAME="rtr-debezium"

echo "deploying resource group"
az group create -n $RESOURCE_GROUP -l EASTUS2

echo "deploying eventhubs namespace"
az eventhubs namespace create -g $RESOURCE_GROUP -n $EVENTHUB_NAME --enable-kafka=true -l EASTUS2
